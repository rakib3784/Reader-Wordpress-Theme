...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="esc_url(https://metabox.io/docs/)">' . __( 'Documentation', 'reader' ) . '</a>';
		$links[] = '<a href="esc_url(https://metabox.io/plugins/)">' . __( 'Extensions', 'reader' ) . '</a>';
		return $links;
	}
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'reader', false, plugin_basename( RWMB_DIR ) . '/languages/' );
	}
