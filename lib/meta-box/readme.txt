...
Tags: reader, custom fields, custom field, meta, readeres, admin, advanced, custom, edit, field, file, image, magic fields, matrix, more fields, Post, repeater, simple fields, text, textarea, type, cms, fields post
...
- [Register Meta Boxes](https://metabox.io/docs/registering-readeres/)
...
- [Meta Box Geolocation](https://metabox.io/plugins/reader-geolocation/): Automatically and instantly populate location data with the power of Google Maps Geolocation API.
...
- [Meta Box Yoast SEO](https://wordpress.org/plugins/reader-yoast-seo/): Add content of custom fields to Yoast SEO Content Analysis to have better/correct SEO score.
- [Meta Box Text Limiter](https://wordpress.org/plugins/reader-text-limiter/): Limit the number of characters or words entered for text and textarea fields.
- [Meta Box Conditional Logic](https://metabox.io/plugins/reader-conditional-logic/): Add visibility dependency for custom meta boxes and custom fields in WordPress.
- [Meta Box Group](https://metabox.io/plugins/reader-group/): Create repeatable groups of custom fields for better appearance and structure.
- [Meta Box Builder](https://metabox.io/plugins/reader-builder/): Create custom meta boxes and custom fields in WordPress using the drag-and-drop interface.
- [Meta Box Template](https://metabox.io/plugins/reader-template/): Define custom meta boxes and custom fields easier with templates.
- [Meta Box Tooltip](https://metabox.io/plugins/reader-tooltip/): Display help information for fields using beautiful tooltips.
- [Meta Box Show Hide (Javascript)](https://metabox.io/plugins/reader-show-hide-javascript/): Toggle meta boxes by page template, post format, taxonomy (including category) via Javascript.
- [Meta Box Tabs](https://metabox.io/plugins/reader-tabs/): Create tabs for meta boxes easily. Support 3 WordPress-native tab styles and tab icon.
- [Meta Box Columns](https://metabox.io/plugins/reader-columns/): Display fields more beautiful by putting them into 12-columns grid.
- [Meta Box Include Exclude](https://metabox.io/plugins/reader-include-exclude/): Show/hide meta boxes by ID, page template, taxonomy or custom function.
...
- [Report Bugs/Issues](https://github.com/rilwis/reader/issues)
- [Premium Extensions](https://metabox.io)

== Installation ==

1. Unzip the download package
1. Upload `reader` to the `/wp-content/plugins/` directory
...
* Improvement: use 'reader' text domain instead of 'rwmb'
* Improvement: coding standards
...
= 4.2 =
* Bug fix: save only last element of `select` field with `multiple` values. [Link](http://wordpress.org/support/topic/plugin-reader-multiple-declaration-for-select-fields-no-longer-working?replies=5#post-3254534)
